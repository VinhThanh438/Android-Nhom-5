package nhom5.android_n5_manager_account.Database;
...
import nhom5.android_n5_manager_account.R;
...
public class DatabaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper.insertSubject("Lập trình C++", 3, 1);
        dbHelper.insertSubject("English 1", 5, 1);
        dbHelper.insertSubject("Triết học", 3, 1);
        dbHelper.insertSubject("Hệ thống cơ sở dữ liệu", 4, 1);
        dbHelper.insertSubject("Kiến trúc máy tính", 3, 1);
        dbHelper.insertSubject("Hệ điều hành", 3, 1);
        dbHelper.insertSubject("Phân tích thiết kế phần mềm", 3, 1);
        dbHelper.insertSubject("Lập trình Java", 3, 2);
        dbHelper.insertSubject("Lập trình .NET", 3, 2);
        dbHelper.insertSubject("Kinh tế chính trị", 2, 2);
        dbHelper.insertSubject("Kỹ thuật số", 3, 2);
        dbHelper.insertSubject("English 2", 5, 2);
        dbHelper.insertSubject("English 3", 5, 3);
        dbHelper.insertSubject("Lập trình Java nâng cao", 3, 3);
        dbHelper.insertSubject("Chủ nghĩa xã hội", 3, 3);
        dbHelper.insertSubject("Trí tuệ nhân tạo", 3, 3);
        dbHelper.insertSubject("Tối ưu hóa", 3, 3);
        dbHelper.insertSubject("Xác xuất thống kê", 3, 3);
        dbHelper.insertSubject("English 4", 5, 4);
        dbHelper.insertSubject("Phân tích dữ liệu lớn", 3, 4);
        dbHelper.insertSubject("Công nghệ đa phương tiện", 3, 4);
        dbHelper.insertSubject("Ứng dụng thuật toán", 3, 4);
        dbHelper.insertSubject("Lịch sử đảng", 2, 4);
        dbHelper.insertSubject("Lập trình game", 3, 4);
        dbHelper.insertSubject("English 5", 5, 5);
        dbHelper.insertSubject("Phát triển ứng dụng trên thiết bị di động", 3, 5);
        dbHelper.insertSubject("Tư tưởng Hồ Chí Minh", 2, 5);
        dbHelper.insertSubject("Thiết kế đồ họa 2D", 3, 5);
        dbHelper.insertSubject("Thực tập cơ sở ngành", 3, 5);
        dbHelper.insertSubject("English 6", 5, 6);
        dbHelper.insertSubject("Quản trị mạng trên hệ điều hành Windows", 3, 6);
        dbHelper.insertSubject("Pháp luật đại cương", 3, 6);
        dbHelper.insertSubject("Tương tác người máy", 3, 6);
        dbHelper.insertSubject("An ninh mạng", 3, 6);
        dbHelper.insertSubject("Thiết kế web nâng cao", 3, 6);
        dbHelper.insertSubject("Kiểm thử phần mềm", 3, 7);
        dbHelper.insertSubject("Đồ án chuyên ngành", 3, 7);
        dbHelper.insertSubject("Tích hợp hệ thống phần mềm", 3, 7);
        dbHelper.insertSubject("Lập trình web bằng Java", 3, 7);
        dbHelper.insertSubject("Đảm bảo chất lượng phần mềm", 3, 7);
        dbHelper.insertSubject("Lập trình PHP nâng cao", 3, 7);
        dbHelper.insertSubject("Đồ án tốt nghiệp", 9, 8);
        dbHelper.insertSubject("Thực tập doanh nghiệp", 6, 8);
